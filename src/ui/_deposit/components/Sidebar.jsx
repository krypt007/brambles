...
const Sidebar = () => {
  ...
  return (
    <div className='hidden md:block text-bold w-[20%] align-top bg-[#242424] p-4 border border-[#303030]'>
        ...
        <div className='flex flex-col justify-between h-[60%]'>
          ...
          <Link to="#" className=' text-white text-bold'>
            <div className='flex justify-start gap-3 p-2 rounded-md'>
              <div className='p-2 justify-center align-center text-purple-700 text-bold object-inline'></div>
              <div className='py-2'></div>
            </div>
          </Link>
          ...
          <div className='flex justify-start gap-3 p-2 rounded-md hover:bg-gray-400 border border-[#303030]'>
        ...
        <div className='flex flex-col justify-end h-[30%]'>
          <Link to="/">
            <div className='flex justify-start gap-3 p-2 rounded-md hover:bg-gray-400 border border-[#303030]' onClick={handleLogout}>
