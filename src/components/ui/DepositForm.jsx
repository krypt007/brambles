...
export default function DepositForm() {
  ...
  const [payStatus, setPayStatus] = useState(2);
 
  return (
    <div className="flex justify-center w-full align-center h-[90%] border-black p-2">
        <Card className="w-full max-w-[24rem] bg-blue-400">
            <CardHeader
                color="white"
                floated={false}
                shadow={false}
                ...
                >
                    ...
                    <form className="mt-12 flex flex-col gap-4">
                        ...
                        />
                            ...
                            { (payStatus == 1) ? (<Button size="lg">Pay Now</Button>): (payStatus == 2) ? (<Button size="lg" className="bg-blue-300">Processing</Button>): (payStatus == 3) ? (<Button size="lg">Payment Successful</Button>): (<Button size="lg">Error</Button>)}
